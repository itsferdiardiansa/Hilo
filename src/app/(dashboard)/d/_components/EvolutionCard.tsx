...
import { FaArrowRight, FaArrowDown, FaMars, FaVenus } from 'react-icons/fa'
...
const ArrowIconRight = styled(FaArrowRight)`
  color: #252525;
  font-size: 16px;
...
const ArrowIconDown = styled(FaArrowDown)`
  color: #252525;
  font-size: 16px;
  display: none;
